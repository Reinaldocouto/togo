...
public class Clinic
{
    ...
    private Clinic(long organizationId, string name, DateTime createdAt)
    {
    ...
    public static Clinic Create(long organizationId, string name, DateTime createdAt) => new(organizationId, name, createdAt);
