...
public class ClinicalEvolutionTests
{
    ...
    {
        var evolution = ClinicalEvolution.Create(1, 10, RegisteredAt, EvolutionType.ClinicalNote, "  Patient stable  ", CreatedByUserId, CreatedAt);

        Assert.Equal(1, evolution.ClinicId);
    ...
    public void Create_ShouldThrowArgumentOutOfRangeException_WhenClinicIdIsInvalid(long clinicId)
    {
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            ClinicalEvolution.Create(clinicId, 10, RegisteredAt, EvolutionType.ClinicalNote, "note", CreatedByUserId, CreatedAt));
    ...
    {
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            ClinicalEvolution.Create(1, attendanceId, RegisteredAt, EvolutionType.ClinicalNote, "note", CreatedByUserId, CreatedAt));
    ...
    public void Create_ShouldThrowArgumentException_WhenRegisteredAtIsDefault()
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            ClinicalEvolution.Create(1, 10, default, EvolutionType.ClinicalNote, "note", CreatedByUserId, CreatedAt));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            ClinicalEvolution.Create(1, 10, RegisteredAt, EvolutionType.ClinicalNote, text, CreatedByUserId, CreatedAt));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            ClinicalEvolution.Create(1, 10, RegisteredAt, EvolutionType.ClinicalNote, "note", Guid.Empty, CreatedAt));
    ...
    {
        var exception = Assert.Throws<ArgumentException>(() =>
            ClinicalEvolution.Create(1, 10, RegisteredAt, EvolutionType.ClinicalNote, "note", CreatedByUserId, default));
    ...
    {
        var evolution = ClinicalEvolution.Create(1, 10, RegisteredAt, EvolutionType.ClinicalNote, "note", CreatedByUserId, CreatedAt);
