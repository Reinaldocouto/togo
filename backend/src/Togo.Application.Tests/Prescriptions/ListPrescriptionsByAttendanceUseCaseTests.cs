...
public class ListPrescriptionsByAttendanceUseCaseTests
{
    ...
    [Fact] public void Repository_ShouldNotExposeGlobalListMethod() { Assert.DoesNotContain(typeof(Togo.Application.Prescriptions.Repositories.IPrescriptionRepository).GetMethods(), method => method.Name == "ListAsync"); }
