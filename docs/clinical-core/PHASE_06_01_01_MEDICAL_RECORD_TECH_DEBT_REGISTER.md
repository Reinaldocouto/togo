...
- MR-DEBT-009 — resolvido tecnicamente no escopo inicial de validação estrutural de `FlagsJson` na Fase 6.5.3; consolidação final recomendada na Fase 6.5.4.
